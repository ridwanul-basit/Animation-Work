...
const TwoRowSlide = () => {
  return (
    <div className="min-h-screen bg-[#FEF9EF] flex flex-col pt-4 pb-14 pr-6 gap-44">
      {/* First Row: Text Card */}
      <div className="w-full max-w-4xl rounded-xl">
        <div >
          <SplitText
            text={`Connecting Hearts \nand Helping Hands`}
            className="text-7xl font-bold text-[#5E362C] mb-4 pl-6"
            delay={0.05} // seconds
            duration={0.6}
            ease="power3.out"
            splitType="chars" // ✅ must use splitType, not split
            from={{ opacity: 0, y: 40 }}
            to={{ opacity: 1, y: 0 }}
            tag="h1"
          />
          ...
          <SplitText
            ...
            className="text-xl text-[#5E362C] pl-8"
            delay={0.1} // seconds
            duration={0.6}
            ease="power3.out"
            splitType="words" // ✅ must use splitType
            from={{ opacity: 0, y: 20 }}
            to={{ opacity: 1, y: 0 }}
          />
      ...
      <div className="w-full grid grid-cols-2 gap-6">
        ...
        <div className="rounded-xl p-8 flex flex-col justify-center">
          <p className="text-xl text-[#5E362C] mb-8">
            ...
            or product it offers. You can use this section to share the company
          ...
          <a
            className="btn w-1/4 bg-[#5E362C] text-white text-xl rounded-3xl px-2 py-6
